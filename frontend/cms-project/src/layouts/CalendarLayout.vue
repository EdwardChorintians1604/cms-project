...
import Home_Calendar_Navbar from '@/components/Home_Calendar_Navbar.vue'
      ...
      <div class="footer-container">
        ...
        <div class="footer-grid">
          ...
          <div class="footer-col">
            ...
            <ul class="footer-links">
              <li><RouterLink to="/" class="footer-link">Beranda</RouterLink></li>
              <li><a href="#kalender" class="footer-link">Lihat Kalender</a></li>
              <li><a href="#bigday" class="footer-link">Lihat Hari Besar</a></li>
            </ul>
          </div>
        ...
        <div class="mycard">
          ...
          <div class="footer-status-badge">
            ...
            <span>GracePoint Church Management System v1.0</span>
          </div>
        </div>
      </div>
    </footer>
