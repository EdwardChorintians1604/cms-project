...
import InfromasiPelayananNavbar from '@/components/InfromasiPelayananNavbar.vue'
...
<template>
  <div class="min-h-screen bg-[var(--theme-bg-primary)] text-[var(--theme-text-primary)] flex flex-col relative transition-colors duration-300">
    <!-- Navbar Sticky (Sama Persis dengan HomeLayout) -->
    <InfromasiPelayananNavbar />
    ...
    <!-- Footer di Dasar Halaman (Sama Persis dengan HomeLayout) -->
...
/* Custom Scrollbar untuk Layer Utama */
