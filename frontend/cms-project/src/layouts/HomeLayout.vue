...
<template>
  <div class="min-h-screen bg-[var(--theme-bg-primary)] text-[var(--theme-text-primary)] flex flex-col relative transition-colors duration-300">
    ...
    <div class="flex flex-1 relative min-w-0">
      ...
      <!-- Area Konten Utama (Bebas dari Geseran Layout) -->
      ...
      <div class="footer-container">
        ...
        <div class="footer-grid">
          ...
          <div class="footer-col footer-col-brand">
            ...
            <p class="footer-description">
              Sistem informasi terpadu untuk pengurusan administrasi, pendataan jemaat, dan koordinasi pelayanan gereja yang transparan, modern, dan akuntabel.
            </p>
          ...
          <div class="footer-col">
            ...
            <ul class="footer-links">
              ...
              <li><a href="#about" class="footer-link">Tentang GracePoint</a></li>
              <li><a href="#information" class="footer-link">Gereja &amp; Pelayanan</a></li>
              <li><a href="#statistic" class="footer-link">Statistik</a></li>
          ...
          <div class="footer-col">
            ...
            <ul class="footer-links">
              ...
              <li><RouterLink to="/user-register" class="footer-link">Registrasi Jemaat</RouterLink></li>
            </ul>
          </div>
          ...
          <div class="footer-col">
            ...
            <div class="footer-contact-info">
              ...
              <div class="contact-item">
                <span class="contact-icon">📞</span>
                <div>
                  <div class="contact-label">Sekretariat</div>
        ...
        <div class="mycard">
          ...
          <div class="footer-status-badge">
            ...
            <span>GracePoint Portal v1.0</span>
          </div>
        </div>
      </div>
    </footer>
...
/* Custom Scrollbar untuk Layer Utama & Sidebar */
